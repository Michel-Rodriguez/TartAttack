...
public class TartasVeganas extends HomeActivity implements AdapterView.OnItemClickListener{
    ...
    ListView miLista;
    private final String [] nombresTarta =new String [] {"Tarta de Chocate Vegana", "Tarta de Manzana Vegana", "Tarta de Queso Vegana",
            "Tarta Fresa Vegana", "Tarta 3 Chocolates Vegana"};
    private final double [] precio = new double[] {25.99, 25.99, 25.99, 25.99, 25.99};
    private final int [] imagenes = new int [] {R.drawable.tarta_chocolate, R.drawable.tarta_manzana_sobre_fondo_blanco_67394_227, R.drawable.tarta_de_queso,
